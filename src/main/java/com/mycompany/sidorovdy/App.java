...
public class App extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel6.setText("Исходный массив");

        jLabel7.setText("Массив с четными индексами");

        jLabel8.setText("Массив с нечетными индексами");
        ...
        jLabel9.setText("<html>Сформировать и вывести двумерный массив 5*7 в таблицу. Значения элементов [-N;M]. <br>Найти сумму эл-в побочной диагонали</html>");

        jLabel10.setText("Введите значение  N:");

        jLabel11.setText("Введите значение  M:");
        ...
        jLabel12.setText("Исходный массив:");

        jLabel13.setText("Сумма равна: ");
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        int n;
        int m;
        int[][]mas_2 = Massiv.generate2(5, 7, -50, 50);
